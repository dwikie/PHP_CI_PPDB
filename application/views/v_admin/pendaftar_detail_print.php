				...
				<table class="table table-bordered table-striped table-hover" id="info-trans">
					<thead>
						<tr class="text-center">
							<th style="padding: 2px !important; background-color: #3399ff !important;">No</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">No. Trans.</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">Kode Trans.</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">Kategori</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">Total Hrs Byr</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">Jumlah Byr</th>
							<th style="padding: 2px !important; background-color: #3399ff !important;">Status Byr</th>
						</tr>
					</thead>
					<tbody>
						<?php $no 	= 1;
